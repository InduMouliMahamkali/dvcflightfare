...
def train_and_evaluate(config_path):
    ...
    print("RandomForestRegressor model (n_estimators=%f, min_samples_split=%f, min_samples_leaf=%f,"
          " max_depth,=%f ,random_state=%f):" % (n_estimators, min_samples_split,min_samples_leaf,
